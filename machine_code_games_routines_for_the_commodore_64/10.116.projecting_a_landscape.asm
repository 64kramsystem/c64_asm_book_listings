...
.const SCREEN_ADDRESS = $0400 // print on the last line
...
//
// With the modification above, if:
//
// - the complexity of plot_element() is not considered,
// - and the ship position is fixed
//
// then the X register can be removed by using:
//
// - cpy #(SHIP_POSITION + RADIUS + 1)
//
// leading to an overall simpler and faster routine than the original (cpy #imm
// is faster than iny+dex).
//
